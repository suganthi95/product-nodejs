// wishlist routes code here
const express =require ("express");
const {addProduct,deleteProduct,createList,getList,updateList,deleteList,getUserInfo,listByUserId,listByUserMail,listByWhishListId} = require ("../controllers/wishlistcontroller.js");
const router = express.Router();
//const Wishlist=require("../cofig/schema.js");
router.post("/addlist",createList);
router.post("/product", addProduct);
//router.post("/addproduct",addProductList)
